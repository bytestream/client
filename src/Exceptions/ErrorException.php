...
class ErrorException extends Exception implements OpenAIThrowable
{
    /**
     ...
     */
    public function __construct(protected readonly array $contents, private readonly int $statusCode)
    {
